...
/*a transaction is an object that has the following properties:
{
    'current-round': 26589028,
    'next-token': 'ZLeVAQAAAAA3AAAA',
    transactions: [
      {
        'close-rewards': 0,
        'closing-amount': 0,
        'confirmed-round': 26589028,
        fee: 1000,
        'first-valid': 26589027,
        'genesis-hash': 'SGO1GKSzyE7IEPItTxCByw9x8FmnrCDexi9/cOUJOiI=',
        'genesis-id': 'testnet-v1.0',
        id: 'ZNZWM7ZWQYSMJONAST6OFPJI3YINZB73SCBPWVBUMQ7LYEZMI2YA',
        'intra-round-offset': 55,
        'last-valid': 26589032,
        note: 'v9SIAQ==',
        'payment-transaction': [Object],
        'receiver-rewards': 0,
        'round-time': 1672234234,
        sender: 'UKSBQH6FOHPZMEQ7YPDSD3AV54XSXRFG744W6WF4QUFEF5SLXVIL7SQ4GM',
        'sender-rewards': 0,
        signature: [Object],
        'tx-type': 'pay'
      }
